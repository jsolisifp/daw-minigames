...
function CreateSprite(file)
{
    ...
    image.style.top = "0px";
    // Cada tile se comporta como una "ventana"
...
{
    // La pantalla de inicio ya está visible en el HTML
    // No necesitamos inicializar el juego todavía
}
function StartGame()
{
...
function PlayAgain()
{
    ...
    // Limpiar objetos, sprites, sonidos y colliders anteriores
    ...
    // Volver a crear e inicializar el juego
    CreateScene();
    StartScene();
}
